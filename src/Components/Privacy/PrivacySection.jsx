...
const PrivacySection = () => {
  const url = "https://seatadda.co.in/api/privacy-policy";
  ...
  return (
    <div className="m-3 sm:p-3 text-left pb-[3rem] sm:pb-0  ">
      <h2 className="font-bold text-2xl  ">Privacy Policy</h2>
      <div className="my-3 p-3 border-[1px] text-xs sm:text-sm font-sans ">
        <h1 className=" font-bold text-center my-2 text-sm sm:text-xl  underline">
          Privacy Notice
        </h1>
