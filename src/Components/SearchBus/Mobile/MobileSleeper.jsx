  ...
  return (
    <div className="">
      <div
        ...
        style={color}
        className="relative cursor-pointer m-2 flex items-center justify-center rounded-sm border-[1px] border-primarycolors-black w-[30px] h-[60px]  "
      >
        <p className="text-center align-middle text-xs">{seatNo}</p>

        <div className=" absolute bottom-[2px] w-[90%] h-[6px]  rounded-[1px] border-[1px] border-primarycolors-black">
