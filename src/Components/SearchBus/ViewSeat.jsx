        ...
        <div className="grid grid-cols-1 md:grid-cols-3 rounded-md  bg-primarycolors-gray/20" >
            ...
            {selectedSeats.length > 0 && (
                <div className="flex flex-col justify-between p-4 text-left h-[98%] shadow-2xl">
                    <div className="my-5">
                    <h1 className="font-bold uppercase text-center text-primarycolors-red">Journey Details:</h1>
                    <div className="mb-2 p-3 text-sm">
                        <p className="m-2">From: <span className="font-bold uppercase">{departure}</span></p>
                        <p className="m-2">To: <span className="font-bold uppercase">{arrival}</span></p>
                        <p className="m-2">Date: <span className="font-bold uppercase">{date}</span></p>
                    </div>
                    <hr className="my-2" />
                    <div className="p-1">
                        <div className="p-2">
                        ...
                        {selectedSeats.map((seat) => (
                            <span className="font-bold" key={seat}> {seat},</span>
                        ))}
                        </div>
                        <div className="p-2">
                        Total Amount:{" "}
                        ...
                        <div className="cursor-pointer px-2 flex justify-center items-center bg-primarycolors-textcolor/20 font-bold rounded w-auto" onClick={handleToggelBoard}>
                        ...
                        {isOpenBoard && (
                            ...
                            {boardingPoints.map((item, index) => (
                                <div key={index} className="cursor-pointer px-4 py-2 hover:bg-primarycolors-red/50" onClick={() => handleSelectBoardOption(item.boading_points)}>
                                {item.boading_points}
                                </div>
                            ))}
                            </div>
                        ...
                        <div className="cursor-pointer px-2 flex justify-center items-center bg-primarycolors-textcolor/20 font-bold rounded w-auto" onClick={handleToggelDrop}>
                        ...
                        {isOpenDrop && (
                            ...
                            {boardingPoints.map((item, index) => (
                                <div key={index} className="cursor-pointer px-4 py-2 hover:bg-primarycolors-red/50" onClick={() => handleSelectDropOption(item.boading_points)}>
                                {item.boading_points}
                                </div>
                            ))}
                            </div>
                    ...
                    <button type="submit" onClick={handleBookSeat} className="py-1 px-2 mx-3 text-primarycolors-white text-lg">
